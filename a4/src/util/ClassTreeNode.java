...
public class ClassTreeNode {
    ...
    /**
     * A boolean flag indicating whether this class was built-in (true) or
     * user-defined (false)
     */
    private boolean builtin;

    /**
     * A boolean flag indicating whether this class is extendable (true) or not
     * (false)
     */
    ...
    /**
     * The (scoped) variable symbol table for this class used for type checking this
     * class
     */
    private SymbolTable varSymbolTable = new SymbolTable();

    /**
     * The (scoped) method symbol table for this class used for type checking this
     * class
     */
     ...
     * In addition, sets variable and method symbol tables to the parent's symbol
     * tables
     * 
    ...
    public void setParent(ClassTreeNode parent) {
        ...
        if (this.parent != parent) {
            ...
            // must also update numDescendants for all ancestors of this parent
            // WARNING: must be careful -- class hierarcy tree may not be well formed
            // must avoid cycles
    ...
    /**
     * Get an iterator of class tree nodes representing the immediate subclasses of
     * this class
     * 
