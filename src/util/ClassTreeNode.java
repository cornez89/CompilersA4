...
public class ClassTreeNode {
    ...
    /** Get the name of the class 
      ...
      * */
    public String getName() { return astNode.getName(); }

    /** Get the AST node for this class
      * @return AST node for this class
      * */
    public Class_ getASTNode() { return astNode; }
     ...
     * */
    public SymbolTable getVarSymbolTable() { return varSymbolTable; }

    /** Get the method symbol table of the class
     * @return method symbol table
     * */
    public SymbolTable getMethodSymbolTable() { return methodSymbolTable; }
